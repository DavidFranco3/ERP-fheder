    ...
    const onSubmit = e => {
        ...
        try {
            cambiaStatusCertificado(id, dataTemp).then(response => {
                ...
                LogsInformativos("Se ha actualizado el estado del certificado de calidad " + folio, datos);
                setShowModal(false);
                setLoading(false);
                history.push({
                    ...
                    (
                        <>
                            <Alert variant="danger">
                                ...
                                <p className="mensaje">
                                    Esta acción deshabilitara en el sistema el certificado de calidad.
                                </p>
                            </Alert>
                        </>
                    ) : (
                        <>
                            <Alert variant="success">
                                ...
                                <p className="mensaje">
                                    Esta acción habilitara en el sistema el certificado de calidad.
                                </p>
                            </Alert>
                        </>
                    )
