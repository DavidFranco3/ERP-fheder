...
import { actualizaPigmento } from "../../../api/pigmento";
import { Button, Col, Form, Row, Spinner } from "react-bootstrap";
import { toast } from "react-toastify";
import queryString from "query-string";
import { LogsInformativos } from "../../Logs/LogsSistema/LogsSistema";

function ModificaPigmento(props) {
    const { dataPigmento, location, history, setShowModal } = props;
    const { id, folio, nombre } = dataPigmento;
    ...
    const [formData, setFormData] = useState(initialFormData(dataPigmento));
...
export default ModificaPigmento;
