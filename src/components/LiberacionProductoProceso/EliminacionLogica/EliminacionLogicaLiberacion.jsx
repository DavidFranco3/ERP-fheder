    ...
    const onSubmit = e => {
        ...
        try {
            cambiaStatusLiberacionProducto(id, dataTemp).then(response => {
                ...
                LogsInformativos("Se ha actualizado el estado de la hoja de liberacion de producto y proceso " + folio, datos);
                setShowModal(false);
                setLoading(false);
                history.push({
                    ...
                    (
                        <>
                            <Alert variant="danger">
                                ...
                                <p className="mensaje">
                                    Esta acción deshabilitara en el sistema la hoja de liberacion de producto y proceso.
                                </p>
                            </Alert>
                        </>
                    ) : (
                        <>
                            <Alert variant="success">
                                ...
                                <p className="mensaje">
                                    Esta acción habilitara en el sistema la hoja de liberacion de producto y proceso.
                                </p>
                            </Alert>
                        </>
                    )
