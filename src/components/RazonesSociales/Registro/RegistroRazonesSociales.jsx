...
import { registraRazonSocial } from "../../../api/razonesSociales";
...
function RegistroRazonesSociales(props) {
    ...
    const onSubmit = e => {
        ...
        try {
            ...
            try {
                registraRazonSocial(dataTempFinal).then(response => {
                    const { data } = response;
...
export default RegistroRazonesSociales;
