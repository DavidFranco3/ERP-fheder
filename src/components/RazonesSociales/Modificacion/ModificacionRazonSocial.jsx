...
function ModificacionRazonSocial(props) {
    ...
    const onSubmit = e => {
        ...
        try {
            ...
            try {
                actualizaRazonSocial(params.id, dataTempFinal).then(response => {
                    const { data } = response;
...
export default ModificacionRazonSocial;
