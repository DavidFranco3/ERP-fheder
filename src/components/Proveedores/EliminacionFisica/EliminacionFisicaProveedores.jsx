...
function EliminacionFisicaProveedores(props) {
    const { dataProveedor, setShowModal, history } = props;
    const { id } = dataProveedor;
    ...
    const onSubmit = e => {
        ...
        try {
            eliminaProveedores(id).then(response => {
                const { data } = response;
                //console.log(data)
                LogsInformativos("El proveedores " + formData.nombre + " fue eliminado del sistema", dataProveedor)
...
export default EliminacionFisicaProveedores;
