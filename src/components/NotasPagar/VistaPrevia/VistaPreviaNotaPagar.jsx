...
import "./VistaPreviaNotaPagar.scss"
...
function VistaPreviaNotaPagar(props) {
                    ...
                    table: {
                        ...
                        body: [
                            [
                                ...
                                {
                                    text: `Cuenta por pagar:  ${formDataFactura.factura}`,
                                    fontSize: 9,
                                    colSpan: 2,
                                    bold: true,
                                },
                            ...
                            [
                                ...
                                {
                                    text: `Monto:  ${new Intl.NumberFormat('es-MX', {
                                        style: "currency",
                                        currency: "MXN"
                                    }).format(formData.tipo == "Devolución" ? formDataFactura.subtotal : formData.totalSinIVA)} MXN`,
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
                                },
                            ...
                            [
                                ...
                                },
                                {
                                    text: `Total:  ${new Intl.NumberFormat('es-MX', {
                                        style: "currency",
                                        currency: "MXN"
                                    }).format(formData.tipo == "Devolución" ? formDataFactura.total : total)} MXN`,
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
                                },
                            ...
                            [
                                {
                                    text: `Concepto:  ${formData.concepto}`,
                                    colSpan: 4,
                                    fontSize: 9,
                                    bold: true
                                },
        ...
        <>
            <Alert>
                <Row>
                    <Col xs={12} md={8}>
                        <h1>
                            Vista detalla de la nota de {formData.tipo}
                        </h1>
                    </Col>
                    <Col xs={6} md={4}>
                        <Button
...
export default VistaPreviaNotaPagar;
