...
function BuscarArticulosAlmacenes(props) {
    const { setFormData, formData, setShowModal, listArticulos, setCantidadExistencia } = props;
    ...
    const articuloElegido = ({ folioArticulo, nombreArticulo, um, almacen, cantidadExistencia }) => {
        // Almacena id, ficha y nombre del socio elegido
        const dataTemp = {
            folioArticulo: folioArticulo,
