...
import "./BuscarEmpaques.scss"
import styled from 'styled-components';
import DataTable from 'react-data-table-component';
import { estilos } from "../../../utils/tableStyled";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faArrowDownLong, faCircleInfo, faPenToSquare, faTrashCan, faEye } from "@fortawesome/free-solid-svg-icons";
import { obtenerEmpaque } from "../../../api/empaques";
import { toast } from "react-toastify";

function BuscarEmpaques(props) {
    const { setFormData, formData, setShowModal, listEmpaque } = props;
    ...
    useEffect(() => {
        try {
            ...
            obtenerEmpaque(clienteSeleccionado.seleccion).then(response => {
                const { data } = response;
    ...
    const filteredItems = listEmpaque.filter(
            ...
            <>
                <Col>
                    <Form.Control
                        id="search"
                        type="text"
                        placeholder="Busqueda por nombre del empaque"
