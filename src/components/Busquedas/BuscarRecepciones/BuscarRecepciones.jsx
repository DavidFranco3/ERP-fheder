...
import "./BuscarRecepciones.scss"
import styled from 'styled-components';
import DataTable from 'react-data-table-component';
import { estilos } from "../../../utils/tableStyled";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faArrowDownLong, faCircleInfo, faPenToSquare, faTrashCan, faEye } from "@fortawesome/free-solid-svg-icons";
import { obtenerRecepcion } from "../../../api/recepcionMaterialInsumos";
import { toast } from "react-toastify";

function BuscarRecepciones(props) {
    const { setFormData, formData, productosRecepcion, setProductosRecepcion, setShowModal, listRecepciones } = props;
    ...
    useEffect(() => {
        try {
            ...
            obtenerRecepcion(clienteSeleccionado.seleccion).then(response => {
                const { data } = response;
    ...
    const onSubmit = e => {
        ...
        if (!clienteSeleccionado.seleccion) {
            ...
            setLoading(true);
            const dataTemp = {
                folioRecepcion: valoresCliente.folio,
            }
            setFormData(dataTemp)
            setProductosRecepcion(valoresCliente.productos)
            setShowModal(false);
        }
    }
...
export default BuscarRecepciones;
