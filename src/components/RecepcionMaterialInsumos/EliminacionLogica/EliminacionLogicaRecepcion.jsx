...
import "./EliminacionLogicaRecepcion.scss";
import { Button, Col, Form, Row, Spinner, Alert } from "react-bootstrap";
import { eliminaDepartamento } from "../../../api/departamentos";
import { toast } from "react-toastify";
import { actualizaEstadoRecepcion } from "../../../api/recepcionMaterialInsumos";
import { LogsInformativos } from "../../Logs/LogsSistema/LogsSistema";

function EliminacionLogicaRecepcion(props) {
    const { datos, setShowModal, history } = props;
    const { id, folio, precio, cantidad, valorTotal, estado } = datos;
    ...
    const onSubmit = e => {
        ...
        try {
            actualizaEstadoRecepcion(id, dataTemp).then(response => {
                const { data } = response;
                //console.log(data)
...
export default EliminacionLogicaRecepcion;
