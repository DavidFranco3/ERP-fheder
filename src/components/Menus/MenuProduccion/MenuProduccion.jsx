        ...
        <>
            ...
            <MenuEscala setRefreshCheckLogin={setRefreshCheckLogin}>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/ReporteProduccion">Reporte de producción</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/CarpetasProceso">Carpetas de proceso</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/IdentificacionPT">Etiqueta de identificación PT</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/MaterialMolido">Id. de material molido</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/ControlParametrosMaquina">Control de parametros de maquina</Link>
                    </h2>
                </li>
            </MenuEscala>
