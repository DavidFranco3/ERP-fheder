        ...
        <>
            ...
            <MenuEscala setRefreshCheckLogin={setRefreshCheckLogin}>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/AlmacenMP" >Almacen de Materia Prima</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/AlmacenPT" >Almacen de Producto Terminado</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/AlmacenGeneral" >Almacen General</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Compras/AlmacenMP" >Compras MP</Link>
                    </h2>
                </li>
            </MenuEscala>
        </>
