...
import { slide as MenuSlide, scaleRotate as MenuEscala } from "react-burger-menu";
        ...
        <>
            ...
            <MenuEscala setRefreshCheckLogin={setRefreshCheckLogin}>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/CatalogoProductos" >Catálogo de productos</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
