        ...
        <>
            ...
            <MenuEscala setRefreshCheckLogin={setRefreshCheckLogin}>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Ventas" >Orden de venta</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                ...
                <li className="homePrincipal">
                    <h2>
                        <Link to="/MatrizProductos" >Matriz de productos</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                ...
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Remisión" >Remisión</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                ...
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Acuses_de_Recibos" >Acuse de recibos</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
