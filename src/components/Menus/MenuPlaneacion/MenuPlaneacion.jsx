        ...
        <>
            ...
            <MenuEscala setRefreshCheckLogin={setRefreshCheckLogin}>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Planeacion" >Planeaciones</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/CatalogoProductos">Catalogo de productos</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/AsignacionPedido">Asignaciones de pedido</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                ...
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Produccion" >Ordenes de Produccion</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Mes" >Programa de producción mes</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Maquinaria" >Programa de producción maquina</Link>
                    </h2>
                </li>
            </MenuEscala>
