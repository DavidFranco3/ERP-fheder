        ...
        <>
            ...
            <MenuEscala setRefreshCheckLogin={setRefreshCheckLogin}>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Calidad" >Inspeccion de calidad de material</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/StatusMaterial" >Identificación de estatus de material</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/InspeccionPieza" >Registro de inspección de pieza</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/PrimeraPieza" >Registro de primera pieza</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/AlertasCalidad" >Alertas de calidad</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/NoConformidad" >Control de no conformidad</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/LiberacionProductoProceso" >Hoja de liberación de producto y proceso</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/FichaTecnica" >Fichas tecnicas</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/CertificadosCalidad" >Certificados de calidad</Link>
                    </h2>
                </li>
            </MenuEscala>
        </>
