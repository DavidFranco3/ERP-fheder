        ...
        <>
            ...
            <MenuEscala setRefreshCheckLogin={setRefreshCheckLogin}>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Compras">Solicitudes de compra</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/SolicitudMaterialInsumo" >Solicitudes de materiales e insumos</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="" >Control de compras</Link>
                    </h2>
                </li>
            </MenuEscala>
        </>
