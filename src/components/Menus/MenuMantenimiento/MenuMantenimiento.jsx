        ...
        <>
            ...
            <MenuEscala setRefreshCheckLogin={setRefreshCheckLogin}>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/Mantenimiento">Orden de mantenimiento</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/EtiquetasMoldes">Etiquetas de moldes</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="">Layout de maquinas</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/InventarioMaquinas">Inventario de maquinas</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/InventarioMoldes">Inventario de moldes</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/MantenimientoPreventivo">Programa de mantenimiento preventivo</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/EntradaSalidaMoldes">Entradas y salidas de moldes</Link>
                    </h2>
                </li>
                <li className="homePrincipal">
                    <h2>
                        <Link to="/VerificacionMantenimientos">Lista de verificacion de mantenimientos preventivos</Link>
                    </h2>
                </li>
            </MenuEscala>
