...
import { habilitaMiercolesT2 } from "../../../api/requerimientosPlaneacion";
import { LogsInformativos } from "../../Logs/LogsSistema/LogsSistema";
import 'dayjs/locale/es'
import dayjs from 'dayjs';
import localizedFormat from 'dayjs/plugin/localizedFormat';

function HabilitarMiercolesT2(props) {
    ...
    const onSubmit = e => {
        ...
        const dataTemp = {
            programa: {
                ...
                estadoMIT2: estadoMIT2 === "false" ? "true" : "false",
                juevesT1: juevesT1,
                estadoJT1: estadoJT1,
                juevesT2: juevesT2,
                estadoJT2: estadoJT2,
        ...
        try {
            habilitaMiercolesT2(id, dataTemp).then(response => {
                const { data } = response;
                // console.log(data)
            ...
            <Form onSubmit={onSubmit}>
                    ...
                    (
                        <>
                            <Alert variant="success">
                                ...
                                <p className="mensaje">
                                    Esta acción habilitara el segundo turno del miercoles.
                                </p>
                            </Alert>
                        </>
                    ) : (<>
                        <Alert variant="danger">
                            ...
                            <p className="mensaje">
                                Esta acción deshabilitara el segundo turno del miercoles.
                            </p>
                        </Alert>
                    </>)
                }
                ...
                <Row>
                    <Form.Group as={Col} controlId="formGridCliente">
                        <Form.Label>
                            Fecha del MiercolesT2
                        </Form.Label>
                        <Form.Control
                            type="text"
                            value={dayjs(miercolesT2).format("LL")}
                            disabled
                        />
                    </Form.Group>
                </Row>
                ...
                <Form.Group as={Row} className="botones">
                    <Col>
                        <Button
                            ...
                            className="registrar"
                        >
                            {!loading ? estadoMIT2 == "true" ? "Deshabilitar" : "Habilitar" : <Spinner animation="border" />}
                        </Button>
                    </Col>
                    <Col>
                        <Button
...
export default HabilitarMiercolesT2;
