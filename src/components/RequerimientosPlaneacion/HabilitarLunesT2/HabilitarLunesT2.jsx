...
import { habilitaLunesT2 } from "../../../api/requerimientosPlaneacion";
import { LogsInformativos } from "../../Logs/LogsSistema/LogsSistema";
import 'dayjs/locale/es'
import dayjs from 'dayjs';
import localizedFormat from 'dayjs/plugin/localizedFormat';

function HabilitarLunesT2(props) {
    ...
    const onSubmit = e => {
        ...
        const dataTemp = {
            programa: {
                ...
                estadoLT1: estadoLT1,
                lunesT2: lunesT2,
                estadoLT2: estadoLT2 === "false" ? "true" : "false",
                martesT1: martesT1,
                estadoMT1: estadoMT1,
                martesT2: martesT2,
                estadoMT2: estadoMT2,
        ...
        try {
            habilitaLunesT2(id, dataTemp).then(response => {
                const { data } = response;
                // console.log(data)
                    ...
                    (
                        <>
                            <Alert variant="success">
                                ...
                                <p className="mensaje">
                                    Esta acción habilitara el segundo turno del lunes.
                                </p>
                            </Alert>
                        </>
                    ) : (<>
                        <Alert variant="danger">
                            ...
                            <p className="mensaje">
                                Esta acción deshabilitara el segundo turno del lunes.
                            </p>
                        </Alert>
                    </>)
                }
                ...
                <Form.Group as={Row} className="botones">
                    <Col>
                        <Button
                            ...
                            className="registrar"
                        >
                            {!loading ? estadoLT2 == "true" ? "Deshabilitar" : "Habilitar" : <Spinner animation="border" />}
                        </Button>
                    </Col>
                    <Col>
                        <Button
...
export default HabilitarLunesT2;
