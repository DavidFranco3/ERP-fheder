...
import { habilitaViernesT1 } from "../../../api/requerimientosPlaneacion";
import { LogsInformativos } from "../../Logs/LogsSistema/LogsSistema";
import 'dayjs/locale/es'
import dayjs from 'dayjs';
import localizedFormat from 'dayjs/plugin/localizedFormat';

function HabilitarViernesT1(props) {
    ...
    const onSubmit = e => {
        ...
        const dataTemp = {
            programa: {
                ...
                estadoJT2: estadoJT2,
                viernesT1: viernesT1,
                estadoVT1: estadoVT1 === "false" ? "true" : "false",
                viernesT2: viernesT2,
                estadoVT2: estadoVT2,
                sabadoT1: sabadoT1,
                estadoST1: estadoST1,
        ...
        try {
            habilitaViernesT1(id, dataTemp).then(response => {
                const { data } = response;
                // console.log(data)
            ...
            <Form onSubmit={onSubmit}>
                    ...
                    (
                        <>
                            <Alert variant="success">
                                ...
                                <p className="mensaje">
                                    Esta acción habilitara el primer turno del viernes.
                                </p>
                            </Alert>
                        </>
                    ) : (<>
                        <Alert variant="danger">
                            ...
                            <p className="mensaje">
                                Esta acción deshabilitara el primer turno del viernes.
                            </p>
                        </Alert>
                    </>)
                }
                ...
                <Row>
                    <Form.Group as={Col} controlId="formGridCliente">
                        ...
                        <Form.Control
                            type="text"
                            value={dayjs(viernesT1).format("LL")}
                            disabled
                        />
                    </Form.Group>
                </Row>
                ...
                <Form.Group as={Row} className="botones">
                    <Col>
                        <Button
                            ...
                            className="registrar"
                        >
                            {!loading ? estadoVT1 == "true" ? "Deshabilitar" : "Habilitar" : <Spinner animation="border" />}
                        </Button>
                    </Col>
                    <Col>
                        <Button
...
export default HabilitarViernesT1;
