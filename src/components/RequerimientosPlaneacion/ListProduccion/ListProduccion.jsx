...
function ListProduccion(props) {
    ...
    const modificaPedidoVenta = (id) => {
        enrutamiento(`/ModificaRequerimientosPlaneacion/${id}`);
    }

    // Para la modificacion de datos del pedido
    const requisicionPlaneacion = (id) => {
        enrutamiento(`/RequisicionPlaneacion/${id}`);
    }

    // Para la modificacion de datos del pedido
    const produccionPlaneacion = (id) => {
        enrutamiento(`/ProduccionPlaneacion/${id}`);
    }

    // Para abrir en una pestaña nueva el pdf de la vista
    const vistaPreviaPlaneacion = (id) => {
        enrutamiento(`/VistaPreviaPlaneacion/${id}`);
    }
