...
import { habilitaMartesT1 } from "../../../api/requerimientosPlaneacion";
import { LogsInformativos } from "../../Logs/LogsSistema/LogsSistema";
import 'dayjs/locale/es'
import dayjs from 'dayjs';
import localizedFormat from 'dayjs/plugin/localizedFormat';

function HabilitarMartesT1(props) {
    ...
    const onSubmit = e => {
        ...
        const dataTemp = {
            programa: {
                ...
                estadoLT2: estadoLT2,
                martesT1: martesT1,
                estadoMT1: estadoMT1 === "false" ? "true" : "false",
                martesT2: martesT2,
                estadoMT2: estadoMT2,
        ...
        try {
            habilitaMartesT1(id, dataTemp).then(response => {
                const { data } = response;
                // console.log(data)
            ...
            <Form onSubmit={onSubmit}>
                    ...
                    (
                        <>
                            <Alert variant="success">
                                ...
                                <p className="mensaje">
                                    Esta acción habilitara el primer turno del martes.
                                </p>
                            </Alert>
                        </>
                    ) : (<>
                        <Alert variant="danger">
                            ...
                            <p className="mensaje">
                                Esta acción deshabilitara el primer turno del martes.
                            </p>
                        </Alert>
                    </>)
                }
                ...
                <Row>
                    <Form.Group as={Col} controlId="formGridCliente">
                        ...
                        <Form.Control
                            type="text"
                            value={dayjs(martesT1).format("LL")}
                            disabled
                        />
                    </Form.Group>
                </Row>
                ...
                <Form.Group as={Row} className="botones">
                    <Col>
                        <Button
                            ...
                            className="registrar"
                        >
                            {!loading ? estadoMT1 == "true" ? "Deshabilitar" : "Habilitar" : <Spinner animation="border" />}
                        </Button>
                    </Col>
                    <Col>
                        <Button
...
export default HabilitarMartesT1;
