...
import { habilitaSabadoT1 } from "../../../api/requerimientosPlaneacion";
import { LogsInformativos } from "../../Logs/LogsSistema/LogsSistema";
import 'dayjs/locale/es'
import dayjs from 'dayjs';
import localizedFormat from 'dayjs/plugin/localizedFormat';

function HabilitarSabadoT1(props) {
    ...
    const onSubmit = e => {
        ...
        const dataTemp = {
            programa: {
                ...
                estadoVT2: estadoVT2,
                sabadoT1: sabadoT1,
                estadoST1: estadoST1 === "false" ? "true" : "false",
            }
        }
        //console.log(dataTemp)

        try {
            habilitaSabadoT1(id, dataTemp).then(response => {
                const { data } = response;
                // console.log(data)
            ...
            <Form onSubmit={onSubmit}>
                    ...
                    (
                        <>
                            <Alert variant="success">
                                ...
                                <p className="mensaje">
                                    Esta acción habilitara el primer turno del sabado.
                                </p>
                            </Alert>
                        </>
                    ) : (<>
                        <Alert variant="danger">
                            ...
                            <p className="mensaje">
                                Esta acción deshabilitara el primer turno del sabado.
                            </p>
                        </Alert>
                    </>)
                }
                ...
                <Row>
                    <Form.Group as={Col} controlId="formGridCliente">
                        ...
                        <Form.Control
                            type="text"
                            value={dayjs(sabadoT1).format("LL")}
                            disabled
                        />
                    </Form.Group>
                </Row>
                ...
                <Form.Group as={Row} className="botones">
                    <Col>
                        <Button
                            ...
                            className="registrar"
                        >
                            {!loading ? estadoST1 == "true" ? "Deshabilitar" : "Habilitar" : <Spinner animation="border" />}
                        </Button>
                    </Col>
                    <Col>
                        <Button
...
export default HabilitarSabadoT1;
