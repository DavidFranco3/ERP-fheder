...
import { habilitaJuevesT1 } from "../../../api/requerimientosPlaneacion";
import { LogsInformativos } from "../../Logs/LogsSistema/LogsSistema";
import 'dayjs/locale/es'
import dayjs from 'dayjs';
import localizedFormat from 'dayjs/plugin/localizedFormat';

function HabilitarJuevesT1(props) {
    ...
    const onSubmit = e => {
        ...
        const dataTemp = {
            programa: {
                ...
                juevesT1: juevesT1,
                estadoJT1: estadoJT1  === "false" ? "true" : "false",
                juevesT2: juevesT2,
                estadoJT2: estadoJT2,
                viernesT1: viernesT1,
                estadoVT1: estadoVT1,
        ...
        try {
            habilitaJuevesT1(id, dataTemp).then(response => {
                const { data } = response;
                // console.log(data)
            ...
            <Form onSubmit={onSubmit}>
                    ...
                    (
                        <>
                            <Alert variant="success">
                                ...
                                <p className="mensaje">
                                    Esta acción habilitara el primer turno del jueves.
                                </p>
                            </Alert>
                        </>
                    ) : (<>
                        <Alert variant="danger">
                            ...
                            <p className="mensaje">
                                Esta acción deshabilitara el primer turno del jueves.
                            </p>
                        </Alert>
                    </>)
                }
                ...
                <Row>
                    <Form.Group as={Col} controlId="formGridCliente">
                        ...
                        <Form.Control
                            type="text"
                            value={dayjs(juevesT1).format("LL")}
                            disabled
                        />
                    </Form.Group>
                </Row>
                ...
                <Form.Group as={Row} className="botones">
                    <Col>
                        <Button
                            ...
                            className="registrar"
                        >
                            {!loading ? estadoJT1 == "true" ? "Deshabilitar" : "Habilitar" : <Spinner animation="border" />}
                        </Button>
                    </Col>
                    <Col>
                        <Button
...
export default HabilitarJuevesT1;
