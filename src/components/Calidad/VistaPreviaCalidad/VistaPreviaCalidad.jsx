...
function VistaPreviaCalidad(props) {
    ...
    const dataPrincipal = () => {
        ...
        if (formData.etiqueta === "Aceptado") {
            ...
            newArray = [
                ...
                [
                    {
                        text: `Comentarios:  ${formData.observaciones}`,
                        fontSize: 9,
                        colSpan: 4,
                        bold: true,
                    },
    ...
    const descargaEtiqueta = async () => {
                    ...
                    table: {
                        ...
                        body: [
                            [
                                ...
                                {
                                    text: `Propiedad:  ${formData.propiedad}`,
                                    fontSize: 9,
                                    colSpan: 2,
                                    bold: true,
                                },
                            ...
                            [
                                {
                                    text: `Cantidad:  ${formData.cantidad} KG`,
                                    colSpan: 2,
                                    bold: true,
                                    fontSize: 9
                                },
                            ...
                            [
                                {
                                    text: `Tipo material:  ${formData.tipoMaterial}`,
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
                                },
                            ...
                            [
                                ...
                                },
                                {
                                    text: [
                                        'Descripción: ',
                                        {
                                            text: formData.nombreDescripcion,
                                            bold: true
                                        }
                                    ],
                                    colSpan: 2,
                            ...
                            [
                                {
                                    text: `Resultado final de la inspección:  ${formData.resultadoFinalInspeccion}`,
                                    colSpan: 2,
                                    bold: true,
                                    fontSize: 9
                                },
                                ...
                                {
                                    text: `Etiqueta:  ${formData.etiqueta}`,
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
                                },
        ...
        const pdf = pdfMake.createPdf(docDefinition);
        pdf.download(`Etiqueta-${formData.folio}.pdf`);
