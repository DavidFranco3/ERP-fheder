...
import { actualizaClasificacionMaquinaria } from "../../../api/clasificacionMaquinaria";
import { LogsInformativos } from "../../Logs/LogsSistema/LogsSistema";
import queryString from "query-string";

function ModificacionClasificacionMaquinaria(props) {
    ...
    const onSubmit = e => {
        ...
        try {
            ...
            try {
                actualizaClasificacionMaquinaria(id, dataTemp).then(response => {
                    const { data } = response;
                    LogsInformativos("Se ha modificado la maquinaria " + dataTemp.nombre, dataTemp);
                    history.push({
...
export default ModificacionClasificacionMaquinaria;
