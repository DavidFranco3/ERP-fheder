...
import "./VistaPreviaProduccion.scss";
...
function VistaPreviaProduccion(props) {
    ...
    let kgMaterial = ((Number(formDataProduccion.pesoPiezas) + (Number(formDataProduccion.pesoColada) / Number(formDataProduccion.cavMolde))) * Number(formDataPlaneacion.cantidadProducir == "" ? formData.cantidadProducir : formDataPlaneacion.cantidadProducir)) * (1 + (Number(formDataProduccion.porcentajeScrap) / 100));
    ...
    let bolsasCajasUtilizar = (Number(formDataPlaneacion.cantidadProducir == "" ? formData.cantidadProducir : formDataPlaneacion.cantidadProducir) / Number(formDataProduccion.noPiezasxEmpaque));
                                ...
                                <Row className="mb-3">
                                    ...
                                    <Form.Group as={Col} controlId="formHorizontalProducto">
                                        ...
                                        <Form.Control
                                            ...
                                            defaultValue={formDataPlaneacion.cantidadProducir == "" ? formData.cantidadProducir : formDataPlaneacion.cantidadProducir}
                                            disabled
                                        />
                                    </Form.Group>
                                </Row>
...
function valoresAlmacenados(data) {
    ...
    return {
        ...
        nombreCliente: generalidades.nombreCliente,
...
export default VistaPreviaProduccion;
