...
import { obtenerNumeroProduccion, obtenerItemProduccion, registraProduccion, obtenerProduccion, actualizaProduccion } from "../../../api/produccion"
    ...
    useEffect(() => {
        ...
        obtenerProduccion(id).then(response => {
            ...
            const dataTemp = {
                ...
                producto: generalidades.producto,
                cliente: generalidades.cliente,
                planeacion: planeacion,
                ordenProduccion: planeacion.ordenProduccion,
                fecha: planeacion.fecha,
                noParte: planeacion.noParte,
                noCavidades: planeacion.noCavidades,
        ...
        if (!formData.fecha) {
            ...
            const dataTemp = {
                generalidades: {
                    ...
                    noInterno: producto == "" ? formData.noInterno : producto.noIntermo,
                    noParte: producto == "" ? formData.noParte : producto.noParte,
                    producto: producto == "" ? formData.producto : producto.descripcion,
                    cliente: producto == "" ? formData.cliente : producto.cliente,
                },
                planeacion: {
                    ordenProduccion: formData.folio,
                    fecha: formData.fecha,
                    noParte: producto == "" ? formData.noParte : producto.noParte,
                    noCavidades: producto == "" ? formData.noCavidades : producto.cavMolde,
                ...
                bom: {
                    material: producto == "" ? formData.material : producto.material,
                    molido: producto == "" ? formData.material : producto.material,
                    pesoPieza: producto == "" ? formData.pesoPieza : producto.pesoPieza,
                    pesoColada: producto == "" ? formData.pesoColada : producto.pesoColada,
                    kgMaterial: formData.kgMaterial,
                    pigmento: producto == "" ? formData.pigmento : producto.pigmentoMb,
                    aplicacion: producto == "" ? formData.aplicacion : producto.aplicacionGxKG,
                    pigMb: formData.kgPIGMB,
                    materialxTurno: formData.materialxTurno,
                    merma: formData.merma,
                    empaque: producto == "" ? formData.empaque : producto.empaque,
                    bolsasCajasUtilizar: producto == "" ? formData.bolsasCajasUtilizar : producto.bolsasCajasUtilizar,
                                    ...
                                    <Row className="mb-3">
                                        ...
                                        <Form.Group as={Col} controlId="formHorizontalNoInterno">
                                            ...
                                            <Form.Control
                                                ...
                                                name="NúmeroInterno"
                                                value={producto == "" ? formData.noInterno : producto.noIntermo}
                                                disabled
                                            />
                                        </Form.Group>
                                    ...
                                    <Row className="mb-3">
                                        <Form.Group as={Col} controlId="formHorizontalProducto">
                                            ...
                                            <Form.Control
                                                ...
                                                name="materialTurno"
                                                defaultValue={formData.materialxTurno}
                                            />
                                        </Form.Group>
...
function valoresAlmacenados(data) {
    const { folio, generalidades, planeacion, bom, observaciones } = data;
