...
function VistaPreviaReporte(props) {
    ...
    useEffect(() => {
        ...
        obtenerReporteProduccion(id).then(response => {
            const { data } = response;
            //console.log(data)
            const { folio, supervisor, turno, asistencias, faltas, fecha, registros, eficienciaGeneralMaquinas, observacionesTurno } = data;
            const dataTemp = {
                folio: folio,
    ...
    const descargaPDF = async () => {
        ...
        const docDefinition = {
            ...
            content: [
                ...
                },
                {
                    ...
                    table: {
                        ...
                        body: [
                            [
                                {
                                    text: `Reporte:  RP-${formData.folio}`,
                                    fontSize: 9,
                                    colSpan: 2,
                                    bold: true
                                },
                            ...
                            [
                                {
                                    text: `Asistencias:  ${formData.asistencias}`,
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
                                },
                            ...
                            [
                                {
                                    text: `Eficiencia general de turno de todas las maquinas:  ${formData.eficienciaGeneralMaquinas}`,
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
                                },
                                ...
                                {
                                    text: `Observaciones generales del turno:  ${formData.observacionesTurno}`,
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
                                },
                ...
                {
                    alignment: 'center',
                    text: 'Listado de registros agregados',
                    style: 'header',
                    fontSize: 23,
                    bold: true,
                    margin: [0, 10],
        ...
        pdf.download(`RP-${formData.folio}.pdf`);
