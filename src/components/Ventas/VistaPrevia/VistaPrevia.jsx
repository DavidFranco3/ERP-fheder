...
import Logo from "../../../assets/png/logoFredher.png";
                    ...
                    table: {
                        ...
                        body: [
                            [
                                ...
                                {
                                    text: `Cliente:  ${formData.nombreCliente == "" ? informacionPedido.nombreCliente : formData.nombreCliente}`,
                                    fontSize: 9,
                                    colSpan: 2,
                                    bold: true,
                                },
                            ...
                            [
                                {
                                    text: `Número de pedido:  ${informacionPedido.numeroPedido}`,
                                    colSpan: 2,
                                    bold: true,
                                    fontSize: 9
                                },
                                ...
                                {
                                    text: `Especificaciones del empaque:  ${informacionPedido.especificaciones}`,
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
                                },
                            ...
                            [
                                {
                                    text: `Fecha de pedido:  ${dayjs(informacionPedido.fechaPedido).format("LL")}`,
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
                                },
                                ...
                                {
                                    text: `Fecha de entrega:  ${dayjs(informacionPedido.fechaEntrega).format("LL")}`,
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
                                },
                            ...
                            [
                                {
                                    text: `Condiciones de pago:  ${informacionPedido.condicionesPago}`,
                                ...
                                {
                                    text: `Lugar de entrega:  ${formData.lugarEntrega == "" ? informacionPedido.lugarEntrega : formData.lugarEntrega}`,
                                    border: [true, true, true, true],
                                    colSpan: 2,
                                    fontSize: 9,
                                    bold: true
