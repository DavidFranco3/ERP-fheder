...
function RegistroVentas(props) {
    ...
    return (
        <>
            <LayoutPrincipal className="RegistroVentas" paginaSeleccionada="Ventas" setRefreshCheckLogin={setRefreshCheckLogin}>
                <Alert>
                    <Row>
                        <Col xs={12} md={8}>
                            <h1>
                                ...
                                <Row>
                                    <Col>
                                        <Button
                                            ...
                                            className="registrar"
                                        >
                                            {!loading ? "Registrar Orden de Venta" : <Spinner animation="border" />}
                                        </Button>
                                    </Col>
                                    <Col>
                                        <Button
